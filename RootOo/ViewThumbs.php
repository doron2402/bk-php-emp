<header><h3 class="tabs_involved">צפייה בתמונות של בעלי עסק</h3></header>
...
foreach ($files as $f)
{
	...
	<img src="'.$up_directory.''.$f.'" width="102" height="40" border="0"><br>'.$f.'</td>';
	$count++;
	if($count%8 == 0)
		echo '</tr><tr>';
}
