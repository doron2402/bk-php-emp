...
echo '<p style="margin-right:0px; margin-left:15px; color:red;">'.$t.'</p><marquee behavior="scroll" direction="up" scrollamount="1"><div id="rss" style="padding-left:10px;">';
...
for ($i=0; $i<=9; $i++)
  ...
  ->item(0)->childNodes->item(0)->nodeValue;
  echo ("<li><a target=\"_blank\" style=\"margin-top:5px; margin-right:0px; \" href='" . $item_link
  . "'>" . $item_title . "</a>");
